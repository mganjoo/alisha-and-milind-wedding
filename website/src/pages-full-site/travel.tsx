...
const TravelPage = () => {
  ...
  return (
    ...
    >
      <SEO title="Travel & Hotel" image="/meta-travel-hero.jpg" />
          ...
          <>
            ...
            <section className="c-article" aria-labelledby="other-airports">
              ...
              <p>
                ...
                toll route when coming in from Oakland.
              </p>
            </section>
            ...
            <section className="c-article" aria-labelledby="hotel-block">
              ...
              <p>
                Please don&rsquo;t hesitate to reach out to us (<ContactEmail />
                ) if any questions come up about travel or booking your stay!
              </p>
            </section>
          </>
        )}
