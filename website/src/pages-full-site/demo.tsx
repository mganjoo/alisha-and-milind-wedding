...
const DemoPage: React.FC = () => {
  ...
  return (
    <BaseLayout>
      <div className="fixed inset-x-0 top-0 w-full flex justify-center items-center py-2 bg-off-white text-gray-900 font-sans text-sm border-b c-subtle-border z-10 shadow-md">
        <button
